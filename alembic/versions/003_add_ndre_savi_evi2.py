...
def upgrade() -> None:
    op.add_column(
        "vegetation_metrics",
        sa.Column(
            "ndre_mean", sa.Float, nullable=True, comment="Red-Edge: nitrogen/chlorophyll stress"
        ),
    )
    op.add_column(
        "vegetation_metrics",
        sa.Column(
            "savi_mean", sa.Float, nullable=True, comment="Soil-Adjusted VI: bare soil correction"
        ),
    )
    op.add_column(
        "vegetation_metrics",
